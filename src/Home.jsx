...
function Home(){
    return(
        ...
        <div id="carouselExampleAutoplaying" class="carousel slide banner" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src={banner1} class="d-block w-100" alt="..."></img>
                </div>
        ...
        <section className="sobre_nos">
            <img src={Logo} alt="Logo KIT ON" className="sobre_nos-logo"></img>
        ...
        <section className='importancia'>
            <div className='importancia-section'>
                ...
                <img src={Enfeite} class="importancia-enfeite" alt="Enfeite visual"></img>
            </div>
            <div className='importancia-section'>
                <img src={Enfeite} class="importancia-enfeite2" alt="Enfeite visual"></img>
        ...
        <section className="como_trabalhamos">
            ...
            <img src={Enfeite2} alt="Enfeite visual" class="como_trabalhamos-enfeite"></img>
        </section>
