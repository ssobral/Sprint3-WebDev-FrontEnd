                    ...
                    <form className='cadastro-card'>
                        ...
                        <div className='cadastro-senhas'>
                            <div>
                                ...
                                <input type="password" id="inputPassword5 senha1" className="form-control" aria-describedby="passwordHelpBlock" required="required"></input>
                            </div>
                            <div>
                                <label for="inputPassword5" className="form-label cadastro-enfeite-texto">Confirme sua senha</label>
                                <input type="password" id="inputPassword5 senha2" className="form-control" aria-describedby="passwordHelpBlock" required="required"></input>
                            </div>
                        </div>
